...
import { addSongToPlaylist, fetchPlaylist } from "../../store/slices/playlistsSlice";
...
const PlaylistView: React.FC = () => {
  ...
  const [showAddToPlaylist, setShowAddToPlaylist] = useState<SongId | null>(null);
            ...
            <div className="playlist-hero-info">
              ...
              <div className="playlist-details">
                ...
                <div className="playlist-meta">
                  <span>
                    Created by {playlist.user.stage_name || playlist.user.username}
                  </span>
  ...
  <button
    key={playlistItem.id}
    onClick={() => handleAddToPlaylist(song.id, playlistItem.id)}
